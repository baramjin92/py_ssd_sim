...
class event_manager :
	...
	def add_accel_time(self, time) :
		self.accel_time = self.accel_time + time
		
	def increase_time(self) :
		if self.accel_time == 0 :
			self.timetick = self.timetick + 1
		else :
			self.timetick = self.timetick + self.accel_time
			self.accel_time = 0
